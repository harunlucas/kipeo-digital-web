...
import { statusLabels } from "./capability-path-card";
 ...
 * the homepage also renders and this redesign must not change.
 */
export function WorkFeaturedSpotlight({ work }: { work: FeaturedWork }) {
